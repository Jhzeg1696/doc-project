...
@Component({
  selector: 'app-canvas5',
  templateUrl: './canvas5.component.html',
  styleUrls: ['./canvas5.component.scss']
})
export class Canvas5Component implements OnInit {
      ...
      if(markers[3] != "a")
      {
        for(let i = 0; i < markers.length; i++)
        {
          if(markers[i][1] == 5)
          {
            ...
            let marker = {id: 5, x: markers[i][3], y: markers[i][4] }
  ...
  newMessage(data: any) 
  {
    this._canvasDataService.changeMessage5(data)
  }
