...
@Component({
  selector: 'app-canvas7',
  templateUrl: './canvas7.component.html',
  styleUrls: ['./canvas7.component.scss']
})
export class Canvas7Component implements OnInit {
      ...
      if(markers[3] != "a")
      {
        for(let i = 0; i < markers.length; i++)
        {
          if(markers[i][1] == 7)
          {
            ...
            let marker = {id: 7, x: markers[i][3], y: markers[i][4] }
  ...
  newMessage(data: any) 
  {
    this._canvasDataService.changeMessage7(data)
  }
