...
@Component({
  selector: 'app-canvas6',
  templateUrl: './canvas6.component.html',
  styleUrls: ['./canvas6.component.scss']
})
export class Canvas6Component implements OnInit {
      ...
      if(markers[3] != "a")
      {
        for(let i = 0; i < markers.length; i++)
        {
          if(markers[i][1] == 6)
          {
            ...
            let marker = {id: 6, x: markers[i][3], y: markers[i][4] }
  ...
  newMessage(data: any) 
  {
    this._canvasDataService.changeMessage6(data)
  }
